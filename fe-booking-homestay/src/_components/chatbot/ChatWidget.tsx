    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-8 right-6 z-50 group chat-btn-pop"
          aria-label="Open Chat"
        >
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-2xl backdrop-blur-xl transition-all duration-300 group-hover:-translate-y-1.5 group-hover:scale-105 group-hover:shadow-[0_0_24px_rgba(17,84,160,0.4)] animate-aura">
            <div className="absolute inset-0 rounded-full bg-linear-to-br from-primary via-primary/75 to-primary/50 opacity-100" />
            <div className="absolute -inset-0.5 rounded-full bg-primary/20 blur-md opacity-75 transition duration-300 group-hover:opacity-100 group-hover:blur-lg" />

            <MessageCircle className="relative z-10 h-7 w-7 text-white drop-shadow-sm transition-transform duration-300 group-hover:rotate-6" />

            <span className="absolute right-0 top-0 z-20 flex h-4 w-4">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
              <span className="relative inline-flex h-4 w-4 rounded-full border-2 border-white bg-green-500 shadow-sm"></span>
            </span>
