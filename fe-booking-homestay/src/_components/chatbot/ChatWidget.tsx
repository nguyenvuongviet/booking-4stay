      ...
      {!open && (
        <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="group relative flex h-11 w-11 md:h-14 md:w-14 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:-translate-y-1.5 hover:scale-105 hover:shadow-[0_0_24px_rgba(17,84,160,0.4)] animate-aura-1 cursor-pointer"
          ...
          >
            ...
            <MessageCircle className="relative z-10 h-5 w-5 md:h-6 md:w-6 text-white drop-shadow-sm transition-transform duration-300 group-hover:scale-110" />

            {/* Unread badge */}
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 z-20 flex h-4.5 min-w-4.5 md:h-5 md:min-w-5 items-center justify-center rounded-full bg-red-500 px-1 text-[9px] md:text-[10px] font-extrabold text-white shadow-sm animate-bounce">
          ...
          <button
            ...
            className="group relative flex h-11 w-11 md:h-14 md:w-14 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:-translate-y-1.5 hover:scale-105 hover:shadow-[0_0_24px_rgba(17,84,160,0.4)] animate-aura-2 cursor-pointer chat-btn-pop"
          ...
          >
            ...
            <Bot className="relative z-10 h-5.5 w-5.5 md:h-7 md:w-7 text-primary drop-shadow-sm transition-transform duration-300 group-hover:rotate-6" />

            {/* Online ping */}
            <span className="absolute right-0 top-0 z-20 flex h-3 w-3 md:h-4 md:w-4">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75" />
              <span className="relative inline-flex h-3 w-3 md:h-4 md:w-4 rounded-full border-2 border-white bg-green-500 shadow-sm" />
            </span>
