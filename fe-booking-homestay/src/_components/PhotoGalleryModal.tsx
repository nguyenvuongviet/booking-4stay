    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 bg-opacity-80">
      <div className="w-11/12 max-w-5xl h-[80vh] bg-background rounded-lg p-4 flex flex-col">
        <div className="flex justify-between items-center mb-2">
          <div className="flex gap-2">
            ...
            {normalImages.length > 0 && (
              <Button
                ...
                className={`px-4 transition
                    ${activeTab === "image" ? "bg-accent shadow" : ""}`}
                variant="ghost"
                size="sm"
              >
            ...
            {images360.length > 0 && (
              <Button
                ...
                className={`px-4 transition
                    ${activeTab === "360" ? "bg-accent shadow" : ""}`}
                variant="ghost"
                size="sm"
              >
          ...
          <button className=" text-gray-700 text-2xl z-50" onClick={onClose}>
            <X size={28} />
          </button>
        </div>
              ...
              <div>
                ...
                {images360.length > 0 && (
                  <div className="absolute bottom-4 right-4 group">
                    ...
                    <div
                      className="absolute bottom-12 right-1/2 translate-x-1/2 text-white text-xs px-2 py-1 
