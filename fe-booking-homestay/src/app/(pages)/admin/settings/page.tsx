          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-border pt-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Bảo vệ tài khoản của bạn bằng cách yêu cầu mã xác thực bổ sung
                khi đăng nhập
              </p>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                description: "Nhận cảnh báo khi khách gửi tin nhắn",
              },
              {
                label: "Đánh giá mới",
                description: "Nhận thông báo khi khách để lại đánh giá",
              },
              {
                label: "Cập nhật thanh toán",
                description: "Cảnh báo xác nhận thanh toán",
              },
              {
                label: "Báo cáo hệ thống",
                description: "Nhận báo cáo hàng ngày/hàng tuần",
              },
              {
                label: "Cảnh báo bảo mật",
                description: "Thông báo về hoạt động bảo mật bất thường",
              },
            ].map((item) => (
              <div
                key={item.label}
